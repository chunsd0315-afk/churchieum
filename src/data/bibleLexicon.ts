...
export const LEXICON_ENTRIES: Record<string, LexiconEntry> = {
  ...
  H7225: {
    strongNumber: 'H7225',
    language: 'hebrew',
    originalText: 'בְּרֵאשִׁית',
    transliteration: "b'reshith",
    pronunciation: '베레쉬트',
    englishGloss: 'in the beginning',
    koreanGlosses: ['처음에', '시작에'],
    briefDefinition: '시작, 첫째, 처음; 특히 시간의 첫 지점을 가리킴.',
    contextualNote: '창세기 1:1의 "태초에"는 בְּרֵאשִׁית(베레쉬트)로, 시간의 절대적 시작점을 선언합니다.',
    morphology: { partOfSpeech: '명사', gender: '여성', number: '단수', lemma: 'רֵאשִׁית' },
  },
  ...
  G3056: {
    ...
    pronunciation: '로고스',
    englishGloss: 'word · message',
    koreanGlosses: ['말씀', '말', '메시지'],
