...
function ChapterView({ book, chapter, totalChapters, highlightVerse, translationMode, onChapterChange, onNavigatePage }: ChapterViewProps) {
  ...
  void (translationMode === 'korean' || translationMode === 'parallel');
  void (translationMode === 'web' || translationMode === 'parallel');
      ...
      {showGrace && (
        <AddToGraceModal
          verse={{
            ...
            verse: saved.verse,
            text: saved.text,
            testament: BOOK_LIST.find(b => b.name === saved.book)?.testament ?? 'old',
            keywords: [],
          }}
