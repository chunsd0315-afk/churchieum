...
import { supabase, Member, Attendance } from '../../services/supabase';
import { CheckSquare, Check, Search } from 'lucide-react';
          ...
          >
            <div className="flex items-center gap-3">
              <div className={`w-10 h-10 rounded-full flex items-center justify-center ${
                isPresent(member.id) ? 'bg-success-500 text-white' : 'bg-gray-100 text-gray-500'
              }`}>
