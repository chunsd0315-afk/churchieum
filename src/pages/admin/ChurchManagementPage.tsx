      ...
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-gray-400 mt-0.5">
            {data.is_verified
              ? <span className="flex items-center gap-1 text-success-600"><Award className="w-3.5 h-3.5" /> 인증된 교회</span>
        ...
        {activeSection === 'contact' && (
          <>
            ...
            <div className="pt-3 border-t border-gray-100">
              ...
              <div className={`flex items-center gap-3 px-4 py-3 rounded-2xl ${data.is_verified ? 'bg-success-50' : 'bg-amber-50'}`}>
                {data.is_verified
                  ? <><CheckCircle className="w-5 h-5 text-success-600 flex-shrink-0" /><div><p className="text-sm font-bold text-success-700">인증 완료</p><p className="text-xs text-success-500">이 교회는 교회이음 인증을 받았습니다</p></div></>
