...
const DEFAULT_CLERGY: ClergyMember[] = [
  { id: 'cl1',  name: '정재명', position: '담임목사',   gender: '남', phone: '010-1000-0001', email: 'pastor01@churchieum.com', address: '서울특별시 성북구 오패산로 89',   status: 'active', isChief: true,  createdAt: '2024-01-01T00:00:00Z', updatedAt: '2024-01-01T00:00:00Z' },
