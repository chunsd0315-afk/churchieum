...
import {
  ...
  CheckCircle, Clock, AlertCircle, Image as ImageIcon, Paperclip,
...
import {
  ...
  type SharingPost, type SharingRequest, type SharingMessage,
...
function MessageModal({ post, user, onSubmit, onClose }: {
  post: SharingPost;
