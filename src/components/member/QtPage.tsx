...
import { supabase, Qt } from '../../lib/supabase';
import { useAuth } from '../../contexts/AuthContext';
import { BookHeart, Calendar, ChevronLeft, ChevronRight, Heart, Pencil, Archive, Check, Send } from 'lucide-react';
...
export default function QtPage() {
  ...
  const handleSaveQtWrite = async () => {
    ...
    try {
      ...
      if (user) {
        await supabase.from('qt_writings').upsert({
          qt_id: selectedQt.id,
          content: myQtContent,
          prayer: myPrayer,
        }).catch(() => null);
