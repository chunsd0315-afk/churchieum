...
import {
  ...
  Download, ChevronLeft, ChevronRight, ZoomIn, Plus, Edit3, Trash2,
} from 'lucide-react';
import { useAuth } from '../../contexts/AuthContext';
import { canWriteContent, getAvailableScopes, type ContentScope } from '../../lib/permissions';
import { getDistricts, getZones, getDepartments } from '../../lib/orgData';
