import {
  ...
  HeartHandshake, BookMarked, User, Church, Target,
} from 'lucide-react';
...
// Book imported for icon consistency reference
void Book;
...
const MEMBER_MENUS: MenuDef[] = [
  ...
  { id: 'announcement',         label: '공지사항', description: '교회 소식과 안내를 확인하세요',           icon: Megaphone,      bg: 'bg-violet-50',  iconColor: 'text-violet-500' },
  ...
  { id: 'bible-reading-center', label: '성경통독', description: '말씀 통독 계획과 진행률을 확인하세요',    icon: Target,         bg: 'bg-green-50',   iconColor: 'text-green-500' },
