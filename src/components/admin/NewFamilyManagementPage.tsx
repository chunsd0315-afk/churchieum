...
import { supabase, NewFamily, Member } from '../../lib/supabase';
import { UserPlus, Plus, Edit, Trash2, X, Calendar, User } from 'lucide-react';
              ...
              <div>
                <div className="flex items-center gap-2 mb-1">
                  ...
                  <span className={`px-2 py-0.5 rounded text-xs ${
                    nf.status === 'registered' ? 'bg-secondary-100 text-secondary-600' :
